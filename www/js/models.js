...
var Forum = exports.Forum = new Schema('Forum', {
    fields: [
        {name: 'title',        type: 'str'},    // 标题
        {name: 'content',      type: 'str'},    // 内容
        {name: 'Browse',       type: 'str'},    // 浏览量
        {name: 'userId',       type: 'str'},    // 创建人
        {name: 'commentNum ',  type: 'number'}, //评论数
...
var ForumComment = exports.ForumComment = new Schema('ForumComment', {
    fields: [
        {name: 'commentContent',type: 'str'},    //评论内容
        {name: 'toUsername',    type: 'str'},    // 回复对象
        {name: 'forumId',       type: 'str'},    // 回复所在帖子Id
...
var ForumCollection = exports.ForumCollection = new Schema('ForumCollection', {
    fields: [
        {name: 'ForumId',       type: 'str'},    // 帖子
        {name: 'userId',        type: 'str'},    // 收藏者
    ]
});
